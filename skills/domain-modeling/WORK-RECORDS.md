# Work records: GitHub Issues and PRs
...
- **Map**: a single issue labelled `wayfinder:map`, holding the map body defined in `/wayfinder`. `gh issue create --label wayfinder:map`.
